...
const LoanContainer = ({amount, emi, interest, url} : Props) => {
    ...
    to-fuchsia-900 text-white p-5 gap-3 rounded-2xl'>
        <p className='fixed flex flex-1 text-[10rem] h-full w-full opacity-20'>LOAN</p>
        ...
        rounded-2xl h-fit w-fit font-semibold items-center' 
        to={url}>
            View details
